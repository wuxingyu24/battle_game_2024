...
wu_Tank::wu_Tank(GameCore *game_core, uint32_t id, uint32_t player_id)
...
void wu_Tank::TankMove(float move_speed, float rotate_angular_speed) {
...
bool wu_Tank::IsHit(glm::vec2 position) const {
